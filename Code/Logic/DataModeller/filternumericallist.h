#ifndef FILTERNUMERICALLIST_H
#define FILTERNUMERICALLIST_H
...
/*!
 * \brief Roles required for FilterNumericalList
...
class FilterNumericalList : public QObject
{
    Q_OBJECT
...
public:
    explicit FilterNumericalList(const int & filterId, const QString & section, const QString & category, const QString & subcategory, const QString & tableName, const QString & columnName, const QString & relation, const QString & slug, const QString & value, const bool & includeNull, const bool & exclude, QObject *parent = nullptr);
