#include "listdatasources.h"

ListDatasources::ListDatasources(QObject *parent) : QObject(parent)
{

}

ListDatasources::ListDatasources(const int &page, const bool &fulllist, const bool &listview, QObject *parent):
    QObject(parent),
    ...
    m_tempStorage(new QByteArray)
{
    ...
    connect(m_networkReply, &QIODevice::readyRead, this, &ListDatasources::reading);
    connect(m_networkReply, &QNetworkReply::finished, this, &ListDatasources::readComplete);
}



void ListDatasources::reading()
{
...
void ListDatasources::readComplete()
{
    ...
    emit listDatasourceStatus(finalStatus);
    m_tempStorage->clear();
}
