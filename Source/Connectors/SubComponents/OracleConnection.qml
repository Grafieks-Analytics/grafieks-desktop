...
Popup {
    ...
    MessageDialog{
        id: msg_dialog
        title: Messages.cn_sub_oracle_subHeader
        text: ""
    ...
    Rectangle{
        ...
        Text{
            id : text1
            text: Messages.cn_sub_oracle_header
    ...
    MessageDialog {
        ...
        visible: false
        title: Messages.cn_sub_oracle_missingDriver
        text: Messages.cn_sub_oracle_driverDownload
