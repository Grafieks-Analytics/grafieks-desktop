...
Popup {
    ...
    // Row : To allow user to login to dropbox
    ...
    Row{
        ...
        Column{
            ...
            Text {
                ...
                text: qsTr("Allow Grafieks desktop to access to your Google Sheets account...")
            ...
            Button{
                ...
                width: 100
                height:50
                x : dropboxConnectionModal.width + sheetPopup.width/2 - allowBtn.width / 2
            ...
            Text {
                ...
                x : dropboxConnectionModal.width + sheetPopup.width/7 + 40

                text: qsTr("Click the allow button above to open the Google authorization page on a separate window.");
            ...
            Text {
                ...
                x : dropboxConnectionModal.width + sheetPopup.width/4 + 40
